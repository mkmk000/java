...
//     (5) public abstract void changeMode() : 모드를 바꾸고 현재 모드를 출력하는 기능 ( NORMAL_MODE -> HARD_MODE / HARD_MODE -> NORMAL_MODE)
	...
	public void rightUpButton() {
		if (num == 0) {
			...
			System.out.println("HARD_MODE : 캐릭터가 연속 공격.");
		}
	}
	...
	public void rightDownButton() {
		if (num == 0) {
			System.out.println("NORMAL_MODE : 캐릭터가 HIT 공격.");
		} else if (num == 1) {
			System.out.println("HARD_MODE : 캐릭터가 Double HIT 공격.");
		}
	}
